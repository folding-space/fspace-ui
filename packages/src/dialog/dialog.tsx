...
export default defineComponent({
     ...
     */
        ...
        const getDialogWidth = () => {
            return props.fullscreen ? "100%" : props.width
        }
        return () => {
            return <transition name='dialog-fade' onBeforeEnter={openClick} onEnter={openedClick}
                onBeforeLeave={closeClick} onLeave={closedClick}>
                {props.visible ? (<div class={'fs-dialog__wrapper'} onClick={handleClose}>
                    <div class='fs-dialog' style={`width:${getDialogWidth()};margin-top:${props.top};`}
